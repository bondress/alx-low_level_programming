0-putchar.c is a C program that prints \_putchar, followed by a new line. The program returns 0.
...
104-fibonacci.c is a C program that finds and prints the first 98 Fibonacci numbers, starting with 1 and 2, followed by a new line.
