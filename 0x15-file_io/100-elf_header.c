...
/**
 * prnt_magic - Prints the magic numbers of an ELF header.
 * @e_ident: A pointer to an array containing the ELF magic numbers.
 *
...
/**
 * prnt_class - Prints the class of an ELF header.
...
/**
 * prnt_data - Prints the data of an ELF header.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void prnt_data(unsigned char *e_ident)
{
...
/**
 * prnt_version - Prints the version of an ELF header.
...
/**
 * prnt_osabi - Prints the OS/ABI of an ELF header.
 * @e_ident: A pointer to an array containing the ELF version.
 */
void prnt_osabi(unsigned char *e_ident)
{
...
/**
 * prnt_abi - Prints the ABI version of an ELF header.
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	prnt_type(header->e_type, header->e_ident);
